...
M.bun.code["build.ts"] = {
  ...
  "",
  "assert(Bun, \"This code MUST be run with Bun!!!\");",
  "",
...
M.bun.code["src/server.ts"] = {
  ...
  "    path.resolve(path.join(import.meta.path, \"..\", \"..\", \"release\")) :",
  "  process.env.NODE_ENV === \"production\" ?",
  "    process.argv[0] === \"bun\" ?",
  "      path.resolve(path.join(process.execPath, \"..\")) :",
  "      path.resolve(path.join(import.meta.path, \"..\")) :",
  "  assert(false, \"Unsupported target \\\"\" + process.env.NODE_ENV + \"\\\"\") as any",
  ");",
  "",
